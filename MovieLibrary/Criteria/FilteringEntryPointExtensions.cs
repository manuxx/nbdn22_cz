...
{
    public static Criteria<TItem> EqualTo<TItem, TProperty>(this FilteringEntryPoint<TItem, TProperty> criteriaBuilder, TProperty value)
    {
        return new AnonymousCriteria<TItem>(movie => criteriaBuilder._selector(movie).Equals(value));
    }

    public static Criteria<TItem> GreaterThan<TItem, TProperty>(this FilteringEntryPoint<TItem, TProperty> criteriaBuilder, TProperty value) 
